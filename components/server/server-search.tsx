...
export const ServerSearch = ({ data }: ServerSearchProp) => {
            ...
            return (
              <CommandGroup key={label} heading={label}>
                {data?.map(({ id, icon, name }) => {
                  return (
                    <CommandItem key={id} onSelect={() => ({ id, type })}>
                      {icon}
                      <span>{name}</span>
                    </CommandItem>
                  );
